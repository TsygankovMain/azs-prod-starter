            ...
            <section class="bg-white rounded-2xl shadow-sm border border-gray-100">
              ...
              <div class="p-5">
                ...
                <p v-if="hasSettingsAccess" class="text-xs text-gray-400 -mt-2 mb-3">
                  «Перевыпустить» снимет несданные задания на сегодня, предупредит сотрудников и пересоздаст по текущему расписанию (сданные не трогает). «Очистить» — снимет несданные и остановит отправку без пересоздания.
                </p>
